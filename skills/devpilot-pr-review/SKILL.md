...
> **Note:** This review was generated automatically by Claude Code running the `devpilot-pr-review` skill. It is not a substitute for human judgment. Treat every finding — including severity labels — as a prompt for the author and human reviewers to verify, not as a final verdict. Approvals do not waive human review.
